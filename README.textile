...
- @motors.motor1.enable(speed)@: Enable motor 1.
- @motors.motor2.enable(speed)@: Enable motor 2.
- @motors.disable()@: Disable both motor 1 and motor 2.
- @motors.motor1.disable(speed)@: Disable motor 1.
- @motors.motor2.disable(speed)@: Disable motor 2.
